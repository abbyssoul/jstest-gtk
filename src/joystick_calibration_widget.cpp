...
JoystickCalibrationWidget::JoystickCalibrationWidget(const std::shared_ptr<Joystick>& joystick)
...
void JoystickCalibrationWidget::on_clear() {
  joystick->clear_calibration();  
  update_with(joystick->get_calibration());
}

void JoystickCalibrationWidget::update_with(const std::vector<Joystick::CalibrationData>& data) {
...
void JoystickCalibrationWidget::on_apply() {
...
void JoystickCalibrationWidget::on_calibrate() {
...
void JoystickCalibrationWidget::on_response(int i) {
  if (i == 0) {
    hide();
  } else if (i == 1) {
    on_clear();
