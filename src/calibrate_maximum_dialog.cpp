...
CalibrateMaximumDialog::CalibrateMaximumDialog(const std::shared_ptr<Joystick>& joystick_)
...
void CalibrateMaximumDialog::on_response(int v) {
  if (v == 0) {
...
void CalibrateMaximumDialog::on_axis_move(size_t id, int value) {
